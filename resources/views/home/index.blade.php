...
@section('content')
<!-- Hero Area Start -->
<section class="hero-area bg-img bg-overlay-2by5" style="background-image: url({{ asset('img/bg') }}/bg1.jpeg);">
    <div class="container h-100">
        <div class="row h-100 align-items-center">
            <div class="col-12">
                <!-- Hero Content -->
                <div class="hero-content text-center">
                    <h2>Selamat Datang di SMK Telkom Terpadu AKN Marzuqi</h2>
                    <a href="https://www.youtube.com/watch?v=c0hoP7Z2UZM" class="btn clever-btn">Sekolah</a>
                </div>
            </div>
        </div>
    </div>
...
<div class="regular-page-area section-padding-100 mt-5 mb-4">
    <div class="col-lg-9 mx-auto">
        <div class="card">
            <div class="card-header">SMK Telkom Terpadu AKN Marzuqi</div>
            <div class="card-body">
                <p class="lead">
                Tentang Kami
                SMK Telkom Terpadu AKN Marzuqi, sekolah islami berbasis industri yang mendedikasikan dirinya untuk menyiapkan lulusan yang siap menghadapi era Society 5.0 (Kolaborasi revolusi Industri 4.0 yang melibatkan digitalisasi, otomatisasi, dan konektivitas dalam industri).
                </p>
            </div>
        </div>
    </div>
